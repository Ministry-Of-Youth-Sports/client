...
const aboutData = [
  {
    title: "ربط جميع الإدارات على مستوى الجمهورية",
    description:
      "المنصة بتجمع كل الإدارات الشبابية والرياضية من جميع المحافظات في مكان واحد، بحيث تقدر توصل لأي إدارة بسهولة من خلال خريطة تفاعلية أو قوائم منظمة.",
    cardColor: "#003D68",
  ...
  },
  {
    ...
    description:
      "بنستخدم أحدث الحلول الرقمية والتقنيات علشان نوفر للشباب وسيلة سريعة وفعّالة للوصول للخدمات والمشاركة في الأنشطة.",
    cardColor: "#866200",
  ...
  },
  {
    ...
    description:
      "تصميم المنصة بسيط وسهل الاستخدام، علشان أي مواطن يقدر يوصل للمعلومة أو الخدمة اللي محتاجها بخطوات قليلة ومن غير تعقيد.",
    cardColor: "#006810",
...
const howItWorks = [
  {
    ...
    backSvgPath: `M36.6,-36.5C52,-21.2,72.1,-10.6,73.6,1.5C75.2,13.7,58.1,27.3,42.7,41C27.3,54.6,13.7,68.3,-2.7,71C-19.1,73.7,-38.2,65.5,-53.6,51.8C-68.9,38.2,-80.6,19.1,-81,-0.3C-81.3,-19.7,-70.3,-39.5,-54.9,-54.8C-39.5,-70,-19.7,-80.8,-4.6,-76.2C10.6,-71.6,21.2,-51.7,36.6,-36.5Z" transform="translate(100 100)`,
  ...
  },
  {
    ...
    backSvgPath: `M49.1,-53.9C57.1,-41.2,52.4,-20.6,52.4,0C52.4,20.6,57.1,41.2,49.1,53.9C41.2,66.7,20.6,71.6,-0.7,72.3C-21.9,72.9,-43.8,69.3,-60.4,56.5C-77.1,43.8,-88.5,21.9,-89.1,-0.6C-89.7,-23.2,-79.6,-46.4,-63,-59.1C-46.4,-71.9,-23.2,-74.2,-1.3,-72.9C20.6,-71.6,41.2,-66.7,49.1,-53.9Z" transform="translate(100 100)`,
    iconBackGround: "#F5F5F5",
    textColor: "#000",
  },
  {
    ...
    backSvgPath: `M32.8,-29.7C42.2,-23.3,49.5,-11.7,54.7,5.3C60,22.2,63.3,44.4,53.8,57.4C44.4,70.5,22.2,74.4,2.2,72.3C-17.8,70.1,-35.7,61.8,-45.7,48.7C-55.8,35.7,-58.2,17.8,-60.5,-2.3C-62.9,-22.5,-65.2,-45,-55.1,-51.3C-45,-57.7,-22.5,-47.8,-5.4,-42.4C11.7,-37,23.3,-36,32.8,-29.7Z" transform="translate(100 100)`,
    iconBackGround: "#F5F5F5",
    textColor: "#000",
  },
  {
    ...
    size: { width: 200, height: 200 },
    backSvgPath: `M30,-35.3C38,-21.9,43.2,-11,44.8,1.5C46.3,14.1,44.2,28.1,36.2,43.9C28.1,59.6,14.1,77.1,-4.1,81.2C-22.3,85.3,-44.5,76,-57.8,60.3C-71,44.5,-75.3,22.3,-72.6,2.7C-70,-16.9,-60.3,-33.8,-47.1,-47.1C-33.8,-60.5,-16.9,-70.3,-3,-67.3C11,-64.4,21.9,-48.6,30,-35.3Z" transform="translate(100 100)`,
    iconBackGround: "#F5F5F5",
    textColor: "#000",
  },
];
