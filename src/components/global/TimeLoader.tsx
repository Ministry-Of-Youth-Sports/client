          ...
          <g transform="translate(2,2)">
            ...
            >
              <circle
                ...
                cx="26"
                strokeWidth="2.5"
                className="hourglass-motion-thick"
              />
              <circle
                transform="rotate(90,26,26)"
                r="24.5"
                ...
                cx="26"
                strokeWidth="1.75"
                className="hourglass-motion-medium"
              />
              <circle
                ...
                cx="26"
                strokeWidth="1"
                className="hourglass-motion-thin"
              />
            </g>

            {/* Hourglass model */}
            <g transform="translate(13.75,9.25)" className="hourglass-model">
              ...
              <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
                <line
                  ...
                  strokeWidth="1"
                  className="hourglass-sand-grain-left"
                />
                <line
                  y2="21.75"
                  x2="12.5"
                  ...
                  strokeDasharray="0.25 33.75"
                  strokeWidth="1"
                  className="hourglass-sand-grain-right"
                />
                <line
                  y2="31.5"
                  x2="12.25"
                ...
                <line
                  ...
                  strokeWidth="1"
                  stroke="hsl(35,90%,83%)"
                  className="hourglass-sand-line-left"
                />
                <line
                  y2="31.5"
                  x2="12.5"
                  ...
                  strokeWidth="1"
                  stroke="hsl(35,90%,83%)"
                  className="hourglass-sand-line-right"
                />
                ...
                <g strokeWidth="0" fill="hsl(35,90%,90%)">
                  <path
                    ...
                    className="hourglass-sand-mound-top"
                  />
                  <path
                    ...
                    className="hourglass-sand-mound-bottom"
                  />
                </g>
              </g>
              ...
              >
                <path
                  ...
                  stroke="hsl(0,0%,100%)"
                  className="hourglass-glare-top"
                />
                <path
                  transform="rotate(180,12.25,16.75)"
                  d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
                  stroke="hsla(0,0%,100%,0)"
                  className="hourglass-glare-bottom"
                />
              </g>
