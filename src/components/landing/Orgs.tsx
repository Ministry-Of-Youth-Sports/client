    ...
    <section className="pt-30" id="orgs">
      ...
      <div className="org-sec-text overflow-x-hidden">
        <div className="p-5">
          ...
          <p>
            تعمل المديرية على إنشاء منصة رقمية متكاملة تجمع كافة الإدارات
            والهيئات التابعة لمديرية الشباب والرياضة بمحافظة القاهرة. وتهدف هذه
            المنصة إلى تمكين المواطنين من الوصول إلى البيانات والخدمات بكل يسر
            وسهولة، بما يعزز مبدأ الشفافية، ويدعم قنوات التواصل الفعّال بين
            الدولة والشباب.
          </p>
        </div>
      ...
      {/* map */}
      <div className="map-container h-[220px] md:h-[400px] w-[95%] lg:w-[80%] mt-10 rounded-xl overflow-hidden mx-auto shadow-[0_0_10px_#848484]">
        <Map />
      </div>
    </section>
  );
